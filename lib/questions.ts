...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'external', label: 'Formation externe (organisme spécialisé) — précisez', points: 6, allowOtherText: true },
    ],
  },
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'role',     label: 'Le rôle',                                        points: 1 },
      { value: 'style',    label: 'Le style / le ton',                              points: 1 },
    ],
  },
  {
    id: 'q10',
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'no',            label: 'Non, jamais',         points: 3 },
    ],
  },
  {
    id: 'q19',
  ...
  },
  {
    ...
    options: [
      { value: 'threat',      label: 'Je reste méfiant sur le traitement des informations via ces outils IA', points: 0 },
